    ...
    <div className="flex h-screen text-black">
      ...
      <div className="flex-1 bg-white px-12 py-8 flex flex-col">
        <div className="flex justify-end gap-8 mb-12 mr-20">
          <Link href="/login" className="font-semibold text-white bg-gray-600 px-4 py-2 rounded-lg" >
            Login
          </Link>
          <Link href="/register" className="font-semibold bg-gray-300 px-4 py-2 rounded-lg hover:underline" >
            Register
          </Link>
        </div>
        ...
        <div className="flex-1 flex flex-col justify-center max-w-lg mx-auto">
          ...
          <div className="flex justify-end mb-8">
            <Link href="#" className="text-gray-700 text-sm font-semibold hover:underline hover:text-blue-600 transition">
              Forget Password ?
            </Link>
          </div>
            ...
            <button
              onClick={handleLogin}
              className="w-full bg-blue-600 text-white font-bold py-3 rounded-lg mb-8 hover:bg-blue-800 transition">
                Login
            </button>
